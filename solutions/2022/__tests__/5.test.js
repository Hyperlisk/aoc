...
describe("Part 1", () => {
  it("should pass", async () => {
    const answer = await actualAoCLib.input.fetchProblemAnswer(2022, 5, 1);

    await import("../../js/2022/5/1.js");
...
describe("Part 2", () => {
  it("should pass", async () => {
    const answer = await actualAoCLib.input.fetchProblemAnswer(2022, 5, 2);

    await import("../../js/2022/5/2.js");
