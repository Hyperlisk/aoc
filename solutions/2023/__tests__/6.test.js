...
describe("Part 1", () => {
  it("should pass", async () => {
    const answer = await actualAoCLib.input.fetchProblemAnswer(2023, 6, 1);

    await import("../../js/2023/6/1.js");
...
describe("Part 2", () => {
  it("should pass", async () => {
    const answer = await actualAoCLib.input.fetchProblemAnswer(2023, 6, 2);

    await import("../../js/2023/6/2.js");
